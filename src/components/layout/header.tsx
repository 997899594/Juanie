  ...
  return (
    <header className="sticky top-0 z-30 px-4 pt-4 md:px-6 lg:px-6">
      ...
      <Dialog open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
        <DialogContent
          layout="bare"
          className="left-0 top-0 h-[100dvh] max-w-none translate-x-0 translate-y-0 rounded-none border-0 p-0 sm:left-0 sm:top-0 sm:!w-screen sm:max-w-none sm:translate-x-0 sm:translate-y-0 sm:rounded-none"
        >
