...
const alertDialogContentSizeClasses = {
  compact: 'sm:[--alert-dialog-content-width:36rem]',
  form: 'sm:[--alert-dialog-content-width:44rem] lg:[--alert-dialog-content-width:54rem]',
} as const;
