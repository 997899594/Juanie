export interface Env {
  ...
  DATABASE_CONSOLE_ROUTE_NAMESPACE?: string;
  DATABASE_CONSOLE_GATEWAY_SERVICE_NAME?: string;
  DATABASE_CONSOLE_TOKEN_SECRET?: string;
  DATABASE_CONSOLE_TOKEN_TTL_SECONDS?: string;
  DBGATE_ENABLED?: 'true' | 'false';
  DBGATE_NAMESPACE?: string;
  DBGATE_HOSTNAME_BASE_DOMAIN?: string;
  DBGATE_IMAGE?: string;
