...
import type { ListAuditLogsInput } from '@juanie/core-types'
...
export class AuditLogsService {
  ...
  // 记录审计日志（内部方法）
  @Trace('audit-logs.log')
  async log(data: LogAuditInput) {
  ...
  async list(userId: string, filters: ListAuditLogsInput) {
    const conditions = []
