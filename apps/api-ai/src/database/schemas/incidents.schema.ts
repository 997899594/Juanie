...
export const IncidentSeverityPgEnum = pgEnum(
  "incident_severity",
...
export const IncidentPriorityPgEnum = pgEnum(
  "incident_priority",
...
export const IncidentStatusPgEnum = pgEnum(
  "incident_status",
  IncidentStatusEnum
);
...
export const IncidentCategoryPgEnum = pgEnum(
  "incident_category",
...
export const incidents = pgTable("incidents", {
  ...
  projectId: uuid("project_id")
    .notNull()
    .references(() => projects.id, { onDelete: "cascade" }), // 项目ID（外键，级联删除）
  reportedBy: uuid("reported_by")
    .notNull()
    .references(() => users.id), // 上报人用户ID（外键）
...
export const insertIncidentSchema = z.object({
  ...
  severity: z.enum(IncidentSeverityEnum),
  priority: z.enum(IncidentPriorityEnum),
  status: z.enum(IncidentStatusEnum).optional(),
  category: z.enum(IncidentCategoryEnum),
  subcategory: z.string().max(50).optional(),
  impactAssessment: z.any().optional(),
  detectionResponse: z.any().optional(),
  technicalDetails: z.any().optional(),
  rootCauseAnalysis: z.any().optional(),
  resolutionMitigation: z.any().optional(),
  communicationUpdates: z.any().optional(),
  aiAssistedResponse: z.any().optional(),
  metricsSla: z.any().optional(),
...
export const selectIncidentSchema = z.object({
  ...
  severity: z.enum(IncidentSeverityEnum),
  priority: z.enum(IncidentPriorityEnum),
  status: z.enum(IncidentStatusEnum),
  category: z.enum(IncidentCategoryEnum),
  subcategory: z.string().nullable(),
  impactAssessment: z.any().nullable(),
  detectionResponse: z.any().nullable(),
  technicalDetails: z.any().nullable(),
  rootCauseAnalysis: z.any().nullable(),
  resolutionMitigation: z.any().nullable(),
  communicationUpdates: z.any().nullable(),
  aiAssistedResponse: z.any().nullable(),
  metricsSla: z.any().nullable(),
  postIncidentReview: z.any().nullable(),
  projectId: z.string().uuid(),
  reportedBy: z.string().uuid(),
...
export const updateIncidentSchema = selectIncidentSchema
  .pick({
    title: true,
    description: true,
    severity: true,
