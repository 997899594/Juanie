  ...
  public get auditLogsRouter() {
    return this.trpc.router({
      ...
      getByOrganization: this.trpc.protectedProcedure
        .input(
          z.object({
            ...
            sortBy: z
              .enum(["createdAt", "action", "outcome", "severity"])
              .default("createdAt"),
        ...
        .query(async ({ input }) => {
          ...
          return this.auditLogsService.getByOrganization(
            organizationId,
            options
          );
        }),
      ...
      getByCorrelationId: this.trpc.protectedProcedure
        ...
        .query(async ({ input, ctx }) => {
          return await this.auditLogsService.getByCorrelationId(
            input.correlationId
          );
        }),
      ...
      getByResource: this.trpc.protectedProcedure
        ...
        .query(async ({ input, ctx }) => {
          ...
          return await this.auditLogsService.getByResource(
            resourceType,
            resourceId,
            options
          );
      ...
      cleanupOldLogs: this.trpc.protectedProcedure
        ...
        .output(z.number())
        .mutation(async ({ input, ctx }) => {
          return await this.auditLogsService.cleanupOldLogs(
