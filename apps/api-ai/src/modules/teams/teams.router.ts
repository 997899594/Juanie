    ...
    this.router = this.trpc.router({
      ...
      getByOrganization: this.trpc.publicProcedure
        ...
        .query(async ({ input }) => {
          ...
          const total = await this.teamsService.getTeamCountByOrganization(input.organizationId);
          return { teams, total };
        }),
      ...
      findBySlug: this.trpc.publicProcedure
        ...
        .query(async ({ input }) => {
          return this.teamsService.findBySlugInOrganization(input.organizationId, input.slug);
        }),
      ...
      getCountByOrganization: this.trpc.publicProcedure
        ...
        .query(async ({ input }) => {
          const count = await this.teamsService.getTeamCountByOrganization(input.organizationId);
          return { count };
        }),
    });
  }
